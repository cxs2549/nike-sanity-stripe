...
export default function Example() {
    const {showCart, setShowCart, totalPrice, totalQuantities, cartItems, toggleCartItemQuanitity, onRemove} = useStateContext()
                ...
                <Dialog.Panel className="pointer-events-auto w-screen max-w-md">
                  <div className="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                    <div className="flex-1 overflow-y-auto py-6 px-4 sm:px-6">
                      <div className="flex items-start justify-between">
                        <Dialog.Title className="text-lg font-medium text-gray-900">
                            {cartItems.length > 0 ? 'Bag' : 'Your Bag is empty.'}
                        </Dialog.Title>
                    ...
                    <div className="border-t border-gray-200 py-6 px-4 sm:px-6">
                      ...
                      <div className="mt-6 flex justify-center items-center gap-1 text-center text-sm text-gray-500">
                        <p>
                          or
                          <button
                            type="button"
