...
function Index() {
  return (
    <div className="pt-16">
      <div className="max-w-7xl mx-auto border-gray-300 dark:border-neutral-700 border-t lg:w-11/12 md:w-11/12 lg:mx-auto md:mx-auto">
          ...
          <div className="xl:flex lg:flex md:flex pt-6">
            <div className="w-11/12 xl:w-3/6 lg:w-2/5 mx-auto lg:mx-0 xl:mx-0">
              <div className="flex items-center mb-6 xl:mb-0 lg:mb-0">
                <img src="/logo.png" className="w-32 dark:invert" alt="" />
                
              </div>
            </div>
            <div className=" mx-auto lg:mx-0 xl:mx-0 pt-3 xl:flex xl:justify-end pl-3 sm:pl-0">
              <ul>
                <li className="text-gray-800 dark:text-white font-bold text-xl mb-6">
                  Community
                </li>
                <li className="text-base  opacity-50 dark:hover:opacity-100 hover:text-gray-700 mb-5">
          ...
          <div className="xl:flex flex-wrap justify-between xl:mt-24 mt-16 pb-6 pl-3 sm:pl-0">
            <div className="w-11/12 xl:w-2/6 mx-auto lg:mx-0 xl:mx-0 mb-6 xl:mb-0">
              <p className="opacity-50 text-sm">
                Copyright &copy; 2022 CxS Development for Nike. All Rights Reserved.
              </p>
            </div>
            <div className="w-11/12 xl:w-2/6 mx-auto lg:mx-0 xl:mx-0 mb-6 lg:mb-0 xl:mb-0">
              <ul className="xl:flex lg:flex md:flex sm:flex justify-between">
                <li className="opacity-50 hover:text-gray-900 text-base mb-4 sm:mb-0">
